...
int main(int argc, char* argv[])
{
    ...
    // At least 5 arguments expected (prog_name + config + routes + ip + message)
    if (argc < 5)
    {
        print_usage(argv[0]);
        return -1;
    ...
    // Check for the optional -e flag at the end
